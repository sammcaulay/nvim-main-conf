...
vim.opt.shiftwidth = 4 -- How wide an indentation is (using >> or <<)
vim.opt.expandtab = true -- Convert tabs to spaces (standard for most languages)
vim.opt.softtabstop = 4 -- Makes backspace delete 4 spaces at once like a single tab
-- ==========================================================================
...
require("lazy").setup({
	...
	-- [DASHBOARD] Startup Screen
	{
		...
		config = function()
			...
			dashboard.section.header.val = require("header")
